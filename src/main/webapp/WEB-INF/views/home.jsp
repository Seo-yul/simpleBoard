...
<script type="text/javascript" src="resources/layout/scripts/jquery.min.js"></script>
<script type="text/javascript" src="resources/layout/scripts/jquery.ui.min.js"></script>
<!-- Homepage Specific -->
<script type="text/javascript" src="resources/layout/scripts/galleryviewthemes/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="resources/layout/scripts/galleryviewthemes/jquery.timers.1.2.js"></script>
<script type="text/javascript" src="resources/layout/scripts/galleryviewthemes/jquery.galleryview.2.1.1.min.js"></script>
<script type="text/javascript" src="resources/layout/scripts/galleryviewthemes/jquery.galleryview.setup.js"></script>
<!-- / Homepage Specific -->
</head>
<body id="top">
<div class="wrapper row1">
  <div id="header" class="clear">
    <div class="fl_left">
      <h1><a href="http://localhost:8888/BoardTest/">Education Board</a></h1>
    ...
    <div id="topnav">
      <ul>
        <li class="active"><a href="http://localhost:8888/BoardTest/">Home</a></li>
        <li><a href="pages/style-demo.html">Style Demo</a></li>
        <li><a href="pages/full-width.html">Full Width</a></li>
        <li><a href="guestBoard">GUEST BOARD</a></li>
...
<div class="wrapper row2">
  <div id="hpage_featured" class="clear"> 
    ...
    <div id="featured_slide">
      <ul>
        <li><img src="resources/images/demo/450x320.gif" alt="" />
        ...
        <li><img src="resources/images/demo/450x320.gif" alt="" /></li>
        <li><img src="resources/images/demo/450x320.gif" alt="" />
          <div class="panel-overlay">
    ...
    <div class="intro clear">
      <div class="welcome clear"><img class="imgl" src="resources/images/demo/imgl.gif" alt="" />
        <div class="fl_right">
    ...
    <div id="homepage" class="clear"> 
      ...
      <div id="content">
        <div id="top_featured" class="clear">
          <ul class="clear">
            <li>
              ...
              <img src="resources/images/demo/300x120.gif" alt="" />
        ...
        <div id="quicklinks">
          ...
          <ul>
            <li>
              <p><a href="#">Make an Application <img src="resources/images/demo/200x80.gif" alt="" /></a></p>
            </li>
            <li>
              <p><a href="#">Order a Prospectus <img src="resources/images/demo/200x80.gif" alt="" /></a></p>
            </li>
            <li class="last">
              <p><a href="#">Support Us <img src="resources/images/demo/200x80.gif" alt="" /></a></p>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div id="column">
        ...
        <div class="holder last">
          ...
          <ul class="staffmembers">
            <li class="clear"><img class="imgl" src="resources/images/demo/80x80.gif" alt="" />
              <div class="fl_left">
  ...
  <div id="footer" class="clear"> 
    ...
    <div class="fl_right">
      <div id="social">
        ...
        <ul>
          <li><a href="#"><img src="resources/images/social/facebook.gif" alt="" /></a></li>
          <li><a href="#"><img src="resources/images/social/twitter.gif" alt="" /></a></li>
          <li><a href="#"><img src="resources/images/social/flickr.gif" alt="" /></a></li>
          <li><a href="#"><img src="resources/images/social/youtube.gif" alt="" /></a></li>
          <li class="last"><a href="#"><img src="resources/images/social/rss.gif" alt="" /></a></li>
        </ul>
      </div>
